        ...
        <input type="hidden" name='hos_id' value="{{$hos->id}}">
          ...
          <div class="col-5">
            <div class="form-group">
              ...
              <input type="tel" class="form-control" name="num" value="{{$hos->hos_name}}" pattern="^(09)\d{9}$" required>
            </div>
          </div>
          <div class="col-7">
            <div class="form-group">
              <label >Email Address</label>
              <input type="email" class="form-control" name="email" value="{{$hos->hos_name}}" required>
            </div>
          </div>
        </div>
          ...
          <div class="container font-weight-normal">
            <div class="row">
              ...
              <div class="form-group col-9 p-0">
                <input type="text" class="form-control" name="street" value="{{$hos->hos_name}}" required>
              </div>
            </div>
            <div class="row">
              <div class="form-group col-3 py-2">
              ...
              <div class="form-group col-9 p-0">
                <input type="text" class="form-control" name="barangay" value="{{$hos->hos_name}}" required>
              </div>
            </div>
            <div class="row">
              <div class="form-group col-3 py-2">
              ...
              <div class="form-group col-9 p-0">
                <input type="text" class="form-control" name="municipality" value="{{$hos->hos_name}}" required>
              </div>
            </div>
            <div class="row">
              <div class="form-group col-3 py-2">
              ...
              <div class="form-group col-9 p-0">
                <input type="text" class="form-control" name="province" value="{{$hos->hos_name}}" required>
              </div>
            </div>
           </div>
        </div>
				<div class="form-group">
					...
					<textarea name="desc" class="form-control text-justify p-10 m-0" value="{{$hos->desc}}"></textarea>
				</div>
				<br>
